...
public class ParameterizedPieceTest { 
    ...
    public static Collection<Object[]> getTestData() {
        return Arrays.asList(new Object[][] {
            ...
            {
                new Bishop(), P("f1"), true, true,
                PList("a6","b5", "c4", "d3","e2","g2","h3"),
                PList("e1", "f2", "i4", "g1"),
                null
            },
            {
                new Bishop(), P("c6"), false, true,
            ...
            {
                new Knight(), P("b1"), true, true,
                PList("a3", "c3", "d2"),
                PList("b3", "a1", "d1", "c2"),
                null
            },
            {
                new Knight(), P("c3"), true, true,
                PList("a2","a4","b1","b5","d1","d5","e2","e4"),
                PList("b2"),
                null
            },
            {
                new Knight(), P("h8"), false, true,
                PList("f7", "g6"),
                PList("i6","j7","f9","j9","i10"),
                null
            },
            {
                new Knight(), P("e7"), false, true,
    ...
    */
    public ParameterizedPieceTest(
        ...
        final Position piecePos,
        final boolean pieceIsWhite,
        final boolean pieceHasMoved,
    ...
    ) 
    {
        ...
        this.currentPiece.setPosition(piecePos);
        this.currentPiece.setIsWhite(pieceIsWhite);
        this.currentPiece.setHasMoved(pieceHasMoved);
