...
public final class Position implements Comparable<Position> {
    ...
    */
    ...
    /**
    * Vergleiche diese Position mit einer anderen.
    *
    * Positionen werden zunächst nach ihrer Zeile, dann nach ihrer
    * Spalte geordnet.
    *
    * @param other zu vergleichende Position
    * @return -1, falls <code>this &lt; other</code>,
    *          0, falls <code>this == other</code>,
    *          1, falls <code>this &gt; other</code>,
    */
