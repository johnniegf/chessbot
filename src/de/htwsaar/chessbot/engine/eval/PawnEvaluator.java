...
public class PawnEvaluator extends EvaluationFunction {
    ...
    private int calculate(Board b) {
        ...
        for (int y = 2; y < 9; y++) {
            ...
            if (pa != null && pa.id() == Pawn.ID && pa.isWhite()) {
                pawnCounts[0] += 1;
                if (pawnCounts[1] == 0) {
                    malus += BACKWARD_PAWN;
                }
            ...
            for (int x = 1; x < col.length - 1; x++) {
                if (b.isFree(P(col[x] + y))) {
                    continue;
                }
                Piece p = b.getPieceAt(P(col[x] + y));
                if (p.id() == Pawn.ID && p.isWhite()) {
                    pawnCounts[x] += 1;
                    ...
                    if (pawnCounts[x - 1] == 0 && pawnCounts[x + 1] == 0) {
                        ...
                        if (pp != null && pp.id() == Pawn.ID && pp.isWhite()) {
                ...
                } else if (p.id() == Pawn.ID && !p.isWhite()) {
                    if (x != 0) {
                        Piece pp = b.getPieceAt(P(col[x - 1] + y));
            ...
            if (ph != null && ph.id() == Pawn.ID && ph.isWhite()) {
                pawnCounts[7] += 1;
                if (pawnCounts[7] == 1) {
                    malus += BACKWARD_PAWN;
    ...
    private int freePawn(int[] pawnCounts, boolean isWhite, int x, Piece pp) {
        ...
        if (pawnCounts[x] == 0) {
            if (x != 7 && pawnCounts[x + 1] == 0) {
                if (x == 0) {
                    malus += FREE_PAWN_COM;
                } else if (pp != null && pp.id() == Pawn.ID && (pp.isWhite() == isWhite)) {
                    if (pawnCounts[x - 1] == 1) {
                        malus += FREE_PAWN_COM;
                    }
                ...
                if (pp != null && pp.id() == Pawn.ID && (pp.isWhite() == isWhite)) {
                    if (pawnCounts[x - 1] == 1) {
                        malus += FREE_PAWN_COM;
                    }
                } else if (pawnCounts[x - 1] == 0) {
