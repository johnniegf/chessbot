...
public class TestCommands {
	...
	private static final String TEST_COMMANDS = 
			...
			+ "test threadcount" + System.lineSeparator()
			+ "test threadstat" + System.lineSeparator()
	...
	private static final String HELP_THREADCOUNT =
			"#Usage: test threadcount" + System.lineSeparator()
			+"#" + System.lineSeparator()
			+ "#  Updates the number of alpha-beta-threads the" + System.lineSeparator()
			+ "#  current earcher uses to the value in the config.";
	private static final String HELP_THREADSTAT =
			"#Usage: test threadstat" + System.lineSeparator()
			+ "#" + System.lineSeparator()
			+ "#  Displays the status of all searcher threads.";
	...
	private static void testHelp(String[] params) {
		...
		case "queuemsg":
			...
			break;
		case "threadcount":
			System.out.println(HELP_THREADCOUNT);
			break;
		case "set":
		...
		case "get":
			...
			break;
		case "threadstat":
			System.out.println(HELP_THREADSTAT);
			break;
		case "record":
	...
	private static void testThreadStat(Engine engine) {
		engine.getSearcher().printThreadStatus();
	}
	...
	private static void testThreadCount(Engine engine) {
		engine.getSearcher().setThreadCount(
				(int) Config.getInstance().getOption(Config.THREAD_COUNT).getValue());
	}
